...
$mpdf->WriteHTML("<img src='imagenes/univalle.jpg' align='left'><h4>Registro de Usuarios Sala Sistemas Univalle 
    Sede Palmira<br/> Universidad del Valle - Sede Palmira</h4><h2>Registros de un Becario</h2>
    <div id='frase'><br/>Registros del becario con código ".$codigo." entre las fechas: ".$fechainicio." y ".$fechafin."
         <br/></div><br/>".$variable);
$mpdf->Output('registrosDelBecario'.$codigo.'.pdf','I');
exit;
?>
