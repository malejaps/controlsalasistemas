<div id="contenido">
    <div class="intertitulobase">Reporte Registros de un Funcionario</div>
    <br/>
    ...
    <div id="formulario">
        ...
        <?php echo form_open('inicioAdministrador/topdfregistrosUnFuncionario', $formulario); ?>
        <table>
            <tbody>

                  <tr>
                    <td><label>Codigo:</label> </td>
                   <td><select id="codigoF" name="codigoF">
